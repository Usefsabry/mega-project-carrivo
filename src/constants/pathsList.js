...
export const STATIC_PATHS = [
  { id: 1, title: "Backend", icon: backendIcon,
  ...
  { id: 2, title: "Frontend", icon: frontendIcon,
  ...
  { id: 3, title: "Data Analyst", icon: dataAnalystIcon,
  ...
  { id: 4, title: "Full Stack", icon: fullStackIcon,
  ...
  { id: 5, title: "AI Engineer", icon: aiEngineerIcon,
  ...
  { id: 6, title: "AI and Data Scientist", icon: aiDataScientistIcon,
  ...
  { id: 7, title: "Blockchain", icon: blockchainIcon,
  ...
  { id: 15, title: "Developer Relations", icon: developerRelationsIcon,
  ...
  { id: 16, title: "Technical Writer", icon: technicalWriterIcon,
